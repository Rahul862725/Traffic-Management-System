...
public:
	...
	void checkd()
	{
		cout<<"Enter 1: If any problem in this lane\n";
		cout<<"Enter 2: If not any problem in this lane\n";
		cout<<"Choose option\n";
		cin>>it;
	}
	void get(int wi)
	{
		cout.width(wi);
			cout<<"Enter 1:If till now problem occure\n";
			cout.width(wi);
    	cout<<"Enter 2: If now problem are not occure\n";
	cin>>it;
	}
...
public:
    vehicle(int e = 0) {
        id = i++;
        emergency = e;
        speed = 1 + 1000 % 71;                //Vehicles with speed 1 - 70
    }
    int getId() {
        return id;
    }
...
class Padestration
{
	public:
		int itp;
		void PadesAllow(int w)
		{
			cout.width(w-5);
			cout<<"Enter 1:Padestration press the button \n";
			cout.width(w);
			cout<<"Enter 2:Padestration are not press the button\n";
			cin>>itp;
		}
...
class traffic_lane : public Input_sensor, public traffic_light, public  Padestration {
public:
    queue<vehicle> qv;
    int laneNo;
    int speedLimit;
